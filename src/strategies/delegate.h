 ...
 **************************************************************************/
#ifndef KQUICKITEMVIEWS_DELEGATE_H
#define KQUICKITEMVIEWS_DELEGATE_H
 ...
 *
 */
class Q_DECL_EXPORT Delegate : public GeometryAdapter
{
    Q_OBJECT
public:
    explicit Delegate(Viewport *parent = nullptr);
    virtual ~Delegate();
